...
public final class IntentExtraUtils {
     ...
     */
    public IntentExtraUtils startActivityFinish(AppCompatActivity activity) {
     ...
     */
    public IntentExtraUtils startActivity(AppCompatActivity activity, int requestCode) {
     ...
     */
    public IntentExtraUtils setResult(AppCompatActivity activity, int resultCode) {
