...
public final class ActivityStackManager {
    ...
    private ArrayMap<String, AppCompatActivity> mActivitySet = new ArrayMap<>();
    ...
    public void finishAllActivities() {
        finishAllActivities((Class<? extends AppCompatActivity>) null);
    }
     ...
     */
    @SafeVarargs
    public final void finishAllActivities(Class<? extends AppCompatActivity>... classArray) {
        String[] keys = mActivitySet.keySet().toArray(new String[]{});
        for (String key : keys) {
            AppCompatActivity activity = mActivitySet.get(key);
            if (activity != null && !activity.isFinishing()) {
                boolean whiteClazz = false;
                if (classArray != null) {
                    for (Class<? extends AppCompatActivity> clazz : classArray) {
