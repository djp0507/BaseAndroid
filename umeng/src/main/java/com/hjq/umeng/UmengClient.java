...
public final class UmengClient {
     ...
     * Activity 统计
     */
    public static void onResume(AppCompatActivity activity) {
        // 手动统计页面
     ...
     * Activity 统计
     */
    public static void onPause(AppCompatActivity activity) {
     ...
     * @param listener              分享监听
     */
    public static void share(AppCompatActivity activity, Platform platform, UmengShare.ShareData data, UmengShare.OnShareListener listener) {
     ...
     * @param listener              登录监听
     */
    public static void login(AppCompatActivity activity, Platform platform, UmengLogin.OnLoginListener listener) {
        if (isAppInstalled(activity, platform.getPackageName())) {
     ...
     * 设置回调
     */
    public static void onActivityResult(AppCompatActivity activity, int requestCode, int resultCode, @Nullable Intent data) {
